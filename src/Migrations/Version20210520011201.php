...
namespace Caio\Doctrine\Migrations;
 ...
 */
final class Version20210520011201 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Curso (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, curso VARCHAR(255) NOT NULL)');
